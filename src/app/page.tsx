...
import SpeechRecognitionIcon from "@/components/SpeechRecognitionIcon";
              ...
              <div className="grid gap-4 md:grid-cols-2 grid-cols-1">
                ...
                <div className="relative z-10 flex flex-col space-x-3 p-3  border rounded-lg shadow-lg  bg-neutral-900 border-neutral-700 shadow-gray-900/20">
                  ...
                  <div className="flex flex-row justify-between w-full">
                    ...
                    <div className="flex flex-row items-center space-x-2 pr-4 cursor-pointer ease-in-out duration-300">
